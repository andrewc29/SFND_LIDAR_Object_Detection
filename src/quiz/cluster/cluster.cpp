...
std::vector<std::vector<int>> Clustering(const std::vector<std::vector<float>>& points, KdTree* tree, float distanceTol)
{
	...
	//for (int i = 0; i < points.size(); ++i){
    //		proximityCluster(clusters[i],points[i],tree,distanceTol);
	//}
